...
<!DOCTYPE html>
    ...
    <h2 style = "margin-left: 500px; margin-top: 80px">Inbox: Sent documents</h2>
    ...
    <?php 
        ...
        try {
            ...
            $sql = "SELECT Username, TheDateTime, DocumentTitle, TimeSent FROM inbox_sent WHERE Username = '$theuser' ORDER BY Id DESC";
            ?>
            ...
            ?>            
                ...
                <tr data-href="">
                <td><?php echo 'Time Sent: ' . $row['TimeSent'] . '<br>'; ?></td>
                </tr>
                <br>
                </table>              
    ...
    <div class="row">
                ...
                <select name="sentdocument" style= "font-weight: bold; margin-left: 600px; transform: translate(-0%, -0%); position: fixed; width: 270px;">
                <?php
                foreach($conn->query($sql, PDO::FETCH_ASSOC) as $row){
                ?>
                ...
                <br>
                <br>
                <button type="button" id="Inbox" name="Inbox" placeholder="Send documents" style= "font-weight: bold; margin-left: 600px; transform: translate(-0%, -0%); position: fixed; width: 270px;" onclick="location.href = 'Inbox.php';">Inbox</button>
                <br>
                <br>
                <br>
                <button type="submit" id="View" name="View" placeholder="View documents" style= "font-weight: bold; margin-left: 600px; transform: translate(-0%, -0%); position: fixed; width: 270px;" onclick="location.href = 'ViewDocument.php';">View Document</button>
                </form> 
                <br>
                <br>
                <br>               
